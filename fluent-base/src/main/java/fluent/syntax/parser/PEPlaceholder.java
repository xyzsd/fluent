...
sealed interface PEPlaceholder {
    ...
    record PlaceableHolder(PatternElement.Placeable placeable) implements PEPlaceholder {}


    record TextElementHolder(int start, int end, int indent,
                             FTLPatternParser.TextElementPosition role) implements PEPlaceholder {
